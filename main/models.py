...
class Category(models.Model):
    ...
    en_name = models.CharField(max_length=60, default='', help_text=_('Type the english translation'), verbose_name='English name')
...
class Head(models.Model):
    ...
    en_title_text = models.CharField(default='',max_length=255, help_text=_('Type the english translation'), verbose_name='English title text')
    def __str__(self):
...
class AboutUs(models.Model):
    ...
    en_title = models.CharField(default='', max_length=60, help_text=_('Type the english translation'), verbose_name='English title text')
    content = models.TextField()
    en_content = models.TextField(default='', help_text=_('Type the english translation'), verbose_name='English content')
    ...
    youtube_vid = models.CharField(max_length=20, help_text=_('Type the youtube embeded code, for example: X8Z8okhkjv8'))
...
class Team(models.Model):
    name = models.CharField(max_length=60)
    en_name = models.CharField(default='', max_length=60, help_text=_('Type name in english'), verbose_name=_('English employee name'))
    image = models.ImageField(upload_to='team', 
        null=True, 
        blank=False
    )
    position = models.CharField(max_length=60, verbose_name=_('Position'))
    en_position = models.CharField(default='', max_length=60, help_text=_('Type name in english'), verbose_name=_('Position in english'))
...
class Client(models.Model):
    name = models.CharField(max_length=60)
    en_name = models.CharField(default='', max_length=60, help_text=_('Type name in english'), verbose_name='English client name')
...
class Social(models.Model):
    ...
    symbol = models.CharField(max_length=13, help_text=_("Available")+": vk, odnoklassniki, facebook, twitter, instagram")
...
class Principle(models.Model):
    title = models.CharField(max_length=50)
    en_title = models.CharField(default='', max_length=50, help_text=_('Type in english translation'), verbose_name='English title')
    image = models.ImageField(upload_to='principles', 
        null=True, 
        blank=False
    )
    content = models.TextField()
    en_content = models.TextField(default='', help_text=_('Type in english translation'), verbose_name='English content')
...
class Contact(models.Model):
    ...
    en_address = models.CharField(max_length=50, help_text=_('Type address in english'), verbose_name='Address in english')
...
class Product(models.Model):
    ...
    en_title = models.CharField(max_length=120, help_text=_('Type in english translation'), verbose_name='English title')

    client_name = models.CharField(max_length=50, blank=True)
    en_client_name = models.CharField(default='', max_length=50, blank=True, help_text=_('Type name in english'), verbose_name='English client name')
    address = models.CharField(max_length=100, blank=True)
    en_address = models.CharField(max_length=100, blank=True, help_text=_('Type address in english'), verbose_name='English address')
    ...
    mini_text = models.CharField(max_length=255, default=None, verbose_name=_('Material'), help_text=_('First material, Second material')) 
    en_mini_text = models.CharField(max_length=255, default='', verbose_name=_('English Material'), help_text=_('Type in english, For example: First material, Second material')) 
...
class ProductGallery(models.Model):
    product = models.ForeignKey(Product,on_delete=models.CASCADE, verbose_name=_('The product'), help_text=_('Choose a project'))
...
class Service(models.Model):
    ...
    en_title = models.CharField(default='', max_length=255, help_text=_('Type in english'), verbose_name='English title')
    slug = models.SlugField(unique=True)
    content = models.TextField()
    en_content = models.TextField(default='', help_text=_('Type the english translation'), verbose_name='English content')
    publish = models.DateTimeField(default=timezone.now)
...
class Testimonial(models.Model):
    ...
    en_fullname = models.CharField(default='', max_length=100, help_text=_('Type fullname in english'), verbose_name='English fullname')
    client = models.CharField(max_length=50, help_text=_('For example: megacom, oobamarket, oshka'))
    en_client = models.CharField(default='', max_length=50, help_text=_('Type name in english'), verbose_name='English client')
    slug = models.SlugField(unique=True)
    ...
    if get_subscribers.count() != 0:
        for user in get_subscribers:
            mail.send_messages(subject=_('We added a new project, check it out'),
                ...
                context={'project_url': 'http://sonunmebel.com/project/{slug}'.format(slug=instance.slug), 'subscriber':user.email, 'contacts':Contact.objects.first()},
