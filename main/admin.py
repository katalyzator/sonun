...
class ProductAdmin(admin.ModelAdmin):
    ...
    ordering = ('-publish',)
    fields = ('title','en_title','client_name','en_client_name','address', 'en_address', 'image', 'content', 'en_content', 'mini_text','en_mini_text','live','category', 'publish',)
...
class ServiceAdmin(admin.ModelAdmin):
    ...
    date_hierarchy = 'publish'
    ordering = ('-publish',)
    fields = ('title','en_title', 'image', 'content', 'en_content', 'mini_text','en_mini_text','live','category', 'publish',)
...
class TestimonialAdmin(admin.ModelAdmin):
    ...
    ordering = ('-timestamp',)
    fields = ('fullname','en_fullname', 'client','en_client', 'image', 'small_image','content','en_content','live', 'timestamp',)
